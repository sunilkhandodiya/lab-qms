...
const NAV = [
  ...
  { href: '/upload-documents', icon: '📄', label: 'Documents',               page: 'documents' },
  { section: 'Configuration' },
  {
    ...
    children: [
      ...
      { href: '/configuration/units',             label: 'Unit' },
      { href: '/configuration/temperatures',      label: 'Temperature' },
      { href: '/configuration/reagent-suppliers', label: 'Reagent Supplier' },
      { href: '/configuration/event-types',       label: 'Event Type' },
      { href: '/configuration/westgard',          label: 'Westgard Rules' },
    ],
  },
];
