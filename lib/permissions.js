...
export const PAGE_ACCESS = {
  ...
  playbook: ALL,
  nc: ['ADMIN', 'DR_PATHOLOGY', 'QUALITY_MANAGER', 'CLUSTER_MANAGER', 'LAB_MANAGER', 'SR_LAB_TECHNICIAN', 'LAB_TECHNICIAN'],
  admin_users:      ['ADMIN'],
...
export const PERMISSIONS = {
  // Internal QC (Levey-Jennings analytes)
  'iqc:add_analyte':   ['ADMIN', 'QUALITY_MANAGER', 'DR_PATHOLOGY', 'LAB_MANAGER'],

  // Configuration screens
  'config:add':    ['ADMIN', 'QUALITY_MANAGER', 'LAB_MANAGER'],
  'config:edit':   ['ADMIN', 'QUALITY_MANAGER', 'LAB_MANAGER'],
  'config:delete': ['ADMIN', 'QUALITY_MANAGER'],
  ...
  // Playbook
  'playbook:create':  ['ADMIN', 'QUALITY_MANAGER', 'DR_PATHOLOGY', 'LAB_MANAGER'],
  'playbook:edit':    ['ADMIN', 'QUALITY_MANAGER', 'DR_PATHOLOGY', 'LAB_MANAGER'],
  'playbook:delete':  ['ADMIN', 'QUALITY_MANAGER'],
  'playbook:run':     ['ADMIN', 'DR_PATHOLOGY', 'QUALITY_MANAGER', 'CLUSTER_MANAGER', 'LAB_MANAGER', 'SR_LAB_TECHNICIAN', 'LAB_TECHNICIAN'],

  // Non-Conformance
  'nc:create':  ['ADMIN', 'DR_PATHOLOGY', 'QUALITY_MANAGER', 'LAB_MANAGER', 'SR_LAB_TECHNICIAN', 'LAB_TECHNICIAN'],
  'nc:edit':    ['ADMIN', 'QUALITY_MANAGER', 'DR_PATHOLOGY', 'LAB_MANAGER'],
  'nc:close':   ['ADMIN', 'QUALITY_MANAGER', 'DR_PATHOLOGY'],
  'nc:delete':  ['ADMIN'],
